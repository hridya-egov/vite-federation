...
const moduleMap = {'react':{get:()=>()=>__federation_import(new URL('__federation_shared_react-5ff928b8.js', import.meta.url).href),import:true},'react-dom':{get:()=>()=>__federation_import(new URL('__federation_shared_react-dom-803b17d3.js', import.meta.url).href),import:false,requiredVersion:'16.13.1'}};
